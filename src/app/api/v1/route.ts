...
export async function GET() {
  return apiResponse({
    ...
    modules: {
      ...
      pharma: [
        { path: "/api/v1/doctors", methods: ["GET", "POST"], description: "Doctor registry with classification and KOL tracking" },
        { path: "/api/v1/doctors/:id", methods: ["GET", "PATCH", "DELETE"], description: "Single doctor" },
        { path: "/api/v1/visits", methods: ["GET", "POST"], description: "Medical rep visit logs" },
        { path: "/api/v1/visits/:id", methods: ["GET", "PATCH", "DELETE"], description: "Single visit" },
        { path: "/api/v1/weekly-plans", methods: ["GET", "POST"], description: "Rep weekly visit plans" },
        { path: "/api/v1/weekly-plans/:id", methods: ["GET", "PATCH", "DELETE"], description: "Single weekly plan" },
        { path: "/api/v1/market-requests", methods: ["GET", "POST"], description: "Sample, literature, event and discount requests" },
        { path: "/api/v1/market-requests/:id", methods: ["GET", "PATCH", "DELETE"], description: "Single market request" },
        { path: "/api/v1/expenses", methods: ["GET", "POST"], description: "Field expense claims" },
        { path: "/api/v1/expenses/:id", methods: ["GET", "PATCH", "DELETE"], description: "Single expense" },
        { path: "/api/v1/kpis", methods: ["GET", "POST"], description: "KPI targets and actuals" },
        { path: "/api/v1/kpis/:id", methods: ["GET", "PATCH", "DELETE"], description: "Single KPI record" },
      ],
      system: [
