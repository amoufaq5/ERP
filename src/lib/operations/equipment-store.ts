...
const SEED_EQUIPMENT: Equipment[] = [
  ...
  {
    id: "eq-002", assetTag: "PRD-FBD-001", name: "Fluid Bed Dryer - Glatt GPCG-60",
    type: "production", model: "GPCG-60", serialNumber: "GL-2020-6012",
    manufacturer: "Glatt", location: "Production Block A, Room A-103",
    department: "Production - Solid Dosage", criticality: "critical",
    status: "operational", installationDate: "2020-03-10",
    lastCalibrationDate: daysAgo(80), nextCalibrationDue: futureDays(10),
    lastMaintenanceDate: daysAgo(30), nextMaintenanceDue: futureDays(60),
  },
  {
    id: "eq-003", assetTag: "PRD-CT-001", name: "Coating Machine - O'Hara Labcoat-II",
    type: "production", model: "Labcoat-II 48\"", serialNumber: "OH-2018-4802",
    manufacturer: "O'Hara Technologies", location: "Production Block A, Room A-105",
    department: "Production - Solid Dosage", criticality: "major",
    status: "operational", installationDate: "2018-11-22",
    lastCalibrationDate: daysAgo(60), nextCalibrationDue: futureDays(30),
    lastMaintenanceDate: daysAgo(15), nextMaintenanceDue: futureDays(75),
  },
  {
    id: "eq-004", assetTag: "PRD-BP-001", name: "Blister Packer - Uhlmann UPS-4",
    type: "production", model: "UPS-4", serialNumber: "UH-2021-4001",
    manufacturer: "Uhlmann", location: "Packaging Hall, Room P-201",
    department: "Packaging", criticality: "major",
    status: "operational", installationDate: "2021-01-18",
    lastCalibrationDate: daysAgo(30), nextCalibrationDue: futureDays(60),
    lastMaintenanceDate: daysAgo(40), nextMaintenanceDue: futureDays(50),
  },
  {
    id: "eq-005", assetTag: "LAB-HPLC-001", name: "HPLC System - Agilent 1260 Infinity II (#1)",
    ...
    status: "operational", installationDate: "2020-07-01",
    lastCalibrationDate: daysAgo(25), nextCalibrationDue: futureDays(65),
    lastMaintenanceDate: daysAgo(50), nextMaintenanceDue: futureDays(40),
  },
  {
    id: "eq-006", assetTag: "LAB-HPLC-002", name: "HPLC System - Agilent 1260 Infinity II (#2)",
    type: "lab", model: "1260 Infinity II", serialNumber: "AG-2020-1261B",
    manufacturer: "Agilent Technologies", location: "QC Lab, Room L-301",
    department: "Quality Control", criticality: "critical",
    status: "calibration-due", installationDate: "2020-07-01",
    lastCalibrationDate: daysAgo(100), nextCalibrationDue: daysAgo(10),
    lastMaintenanceDate: daysAgo(55), nextMaintenanceDue: futureDays(35),
  },
  {
    id: "eq-007", assetTag: "LAB-HPLC-003", name: "HPLC System - Waters Alliance e2695 (#3)",
    type: "lab", model: "Alliance e2695", serialNumber: "WA-2019-2695C",
    manufacturer: "Waters Corporation", location: "QC Lab, Room L-302",
    department: "Quality Control", criticality: "critical",
    status: "under-maintenance", installationDate: "2019-04-15",
    lastCalibrationDate: daysAgo(40), nextCalibrationDue: futureDays(50),
    lastMaintenanceDate: daysAgo(5), nextMaintenanceDue: futureDays(85),
  },
  {
    id: "eq-008", assetTag: "LAB-DT-001", name: "Dissolution Tester - Agilent 708-DS",
    type: "lab", model: "708-DS", serialNumber: "AG-2021-7081",
    manufacturer: "Agilent Technologies", location: "QC Lab, Room L-303",
    department: "Quality Control", criticality: "major",
    status: "operational", installationDate: "2021-02-28",
    lastCalibrationDate: daysAgo(35), nextCalibrationDue: futureDays(55),
    lastMaintenanceDate: daysAgo(60), nextMaintenanceDue: futureDays(30),
  },
  {
    id: "eq-009", assetTag: "LAB-BAL-001", name: "Analytical Balance - Mettler Toledo XPR205 (#1)",
    type: "lab", model: "XPR205", serialNumber: "MT-2022-2051",
    manufacturer: "Mettler Toledo", location: "QC Lab, Room L-304",
    department: "Quality Control", criticality: "critical",
    status: "operational", installationDate: "2022-01-10",
    lastCalibrationDate: daysAgo(15), nextCalibrationDue: futureDays(75),
    lastMaintenanceDate: daysAgo(90), nextMaintenanceDue: futureDays(0),
  },
  {
    id: "eq-010", assetTag: "LAB-BAL-002", name: "Analytical Balance - Mettler Toledo XPR205 (#2)",
    type: "lab", model: "XPR205", serialNumber: "MT-2022-2052",
    manufacturer: "Mettler Toledo", location: "Dispensing Room, Room D-101",
    department: "Production - Dispensing", criticality: "critical",
    status: "calibration-due", installationDate: "2022-01-10",
    lastCalibrationDate: daysAgo(95), nextCalibrationDue: daysAgo(5),
    lastMaintenanceDate: daysAgo(80), nextMaintenanceDue: futureDays(10),
  },
  {
    id: "eq-011", assetTag: "UTL-AC-001", name: "Autoclave - Getinge GEV-600",
    type: "utility", model: "GEV-600", serialNumber: "GT-2018-6001",
    manufacturer: "Getinge", location: "Sterile Area, Room S-102",
    department: "Production - Sterile", criticality: "critical",
    status: "operational", installationDate: "2018-08-20",
    lastCalibrationDate: daysAgo(20), nextCalibrationDue: futureDays(70),
    lastMaintenanceDate: daysAgo(25), nextMaintenanceDue: futureDays(65),
  },
  {
    id: "eq-012", assetTag: "UTL-WP-001", name: "Water Purification System - MECO PureGen",
  ...
  {
    id: "eq-013", assetTag: "HVAC-AHU-001", name: "AHU - Production Block A",
    type: "HVAC", model: "Custom AHU-5000", serialNumber: "AHU-2018-A001",
    manufacturer: "Daikin", location: "Mechanical Floor, MF-01",
    department: "Engineering - HVAC", criticality: "critical",
    status: "operational", installationDate: "2018-06-01",
    lastCalibrationDate: daysAgo(50), nextCalibrationDue: futureDays(40),
    lastMaintenanceDate: daysAgo(28), nextMaintenanceDue: futureDays(2),
  },
  {
    id: "eq-014", assetTag: "HVAC-AHU-002", name: "AHU - QC Laboratory",
    type: "HVAC", model: "Custom AHU-3000", serialNumber: "AHU-2018-L001",
    manufacturer: "Daikin", location: "Mechanical Floor, MF-02",
    department: "Engineering - HVAC", criticality: "major",
    status: "operational", installationDate: "2018-06-01",
    lastCalibrationDate: daysAgo(55), nextCalibrationDue: futureDays(35),
    lastMaintenanceDate: daysAgo(35), nextMaintenanceDue: futureDays(55),
  },
  {
    id: "eq-015", assetTag: "PRD-GR-001", name: "High-Shear Granulator - Diosna P250",
  ...
  {
    id: "eq-016", assetTag: "PRD-MX-001", name: "V-Blender - Patterson-Kelley 10 cu ft",
    type: "production", model: "PK-V-10", serialNumber: "PK-2020-1001",
    manufacturer: "Patterson-Kelley", location: "Production Block A, Room A-104",
    department: "Production - Solid Dosage", criticality: "major",
    status: "operational", installationDate: "2020-05-20",
    lastCalibrationDate: daysAgo(40), nextCalibrationDue: futureDays(50),
    lastMaintenanceDate: daysAgo(45), nextMaintenanceDue: futureDays(45),
  },
  {
    id: "eq-017", assetTag: "PRD-CF-001", name: "Capsule Filler - Bosch GKF-2500",
    type: "production", model: "GKF-2500", serialNumber: "BS-2021-2501",
    manufacturer: "Bosch Packaging", location: "Production Block B, Room B-201",
    department: "Production - Solid Dosage", criticality: "major",
    status: "operational", installationDate: "2021-08-15",
    lastCalibrationDate: daysAgo(55), nextCalibrationDue: futureDays(35),
    lastMaintenanceDate: daysAgo(20), nextMaintenanceDue: futureDays(70),
  },
  {
    id: "eq-018", assetTag: "LAB-SC-001", name: "Stability Chamber - Binder KBF-720",
    type: "lab", model: "KBF-720", serialNumber: "BD-2020-7201",
    manufacturer: "Binder", location: "Stability Lab, Room L-401",
    department: "Quality Control - Stability", criticality: "critical",
    status: "operational", installationDate: "2020-10-01",
    lastCalibrationDate: daysAgo(18), nextCalibrationDue: futureDays(72),
    lastMaintenanceDate: daysAgo(60), nextMaintenanceDue: futureDays(30),
  },
  {
    id: "eq-019", assetTag: "HVAC-AHU-003", name: "AHU - Sterile Manufacturing",
    type: "HVAC", model: "Custom AHU-4000", serialNumber: "AHU-2018-S001",
    manufacturer: "Daikin", location: "Mechanical Floor, MF-03",
    department: "Engineering - HVAC", criticality: "critical",
    status: "operational", installationDate: "2018-06-01",
    lastCalibrationDate: daysAgo(42), nextCalibrationDue: futureDays(48),
    lastMaintenanceDate: daysAgo(30), nextMaintenanceDue: futureDays(60),
  },
  {
    id: "eq-020", assetTag: "PRD-TP-002", name: "Tablet Press - Fette P2020",
    type: "production", model: "P2020", serialNumber: "FE-2022-2020",
    manufacturer: "Fette Compacting", location: "Production Block B, Room B-101",
    department: "Production - Solid Dosage", criticality: "critical",
    status: "retired", installationDate: "2015-03-01",
    lastCalibrationDate: daysAgo(200), nextCalibrationDue: daysAgo(110),
    lastMaintenanceDate: daysAgo(180), nextMaintenanceDue: daysAgo(90),
    notes: "Retired. Replaced by Cadmach CU-45.",
  },
];
