...
export interface SalesOrder {
  ...
  date: string;
  expectedDate: string;
  items: { productId: string; description: string; quantity: number; unitPrice: number; discountPct: number; total: number }[];
  subtotal: number;
  discountPct: number;
  discountAmount: number;
  tax: number;
...
const SEED_SALES_ORDERS: SalesOrder[] = [
  { id: "so-001", number: "SO-2026-0001", customerId: "c-001", date: daysAgo(15), expectedDate: daysAgo(3), items: [{ productId: "p-cardio-1", description: "Cardioprex 500mg Tablet", quantity: 500, unitPrice: 48, discountPct: 0, total: 24000 }, { productId: "p-cardio-2", description: "Atorvastat 20mg Tablet", quantity: 300, unitPrice: 62, discountPct: 0, total: 18600 }], subtotal: 42600, discountPct: 0, discountAmount: 0, tax: 5964, total: 48564, status: "INVOICED", invoiceId: "inv-001", dnId: "dn-001", createdAt: daysAgo(15) },
  { id: "so-002", number: "SO-2026-0002", customerId: "c-002", date: daysAgo(8), expectedDate: daysAhead(2), items: [{ productId: "p-diab-1", description: "Diabetex XR 1000mg Tablet", quantity: 200, unitPrice: 95, discountPct: 0, total: 19000 }], subtotal: 19000, discountPct: 0, discountAmount: 0, tax: 2660, total: 21660, status: "CONFIRMED", createdAt: daysAgo(8) },
  { id: "so-003", number: "SO-2026-0003", customerId: "c-003", date: daysAgo(3), expectedDate: daysAhead(10), items: [{ productId: "p-prim-1", description: "Antibio-Z 1g Capsule", quantity: 1000, unitPrice: 28, discountPct: 0, total: 28000 }, { productId: "p-prim-2", description: "Paraflu Junior Syrup", quantity: 500, unitPrice: 22, discountPct: 0, total: 11000 }], subtotal: 39000, discountPct: 0, discountAmount: 0, tax: 5460, total: 44460, status: "DRAFT", createdAt: daysAgo(3) },
];
