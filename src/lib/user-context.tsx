...
export const ROLE_ROUTES: Record<UserRole, string[]> = {
  ...
  BUM: [
    ...
    "/crm/business-units", "/crm/territories", "/crm/doctors", "/crm/gps-tracking", "/crm/market-requests", "/crm/reports",
  ...
  DISTRICT_MANAGER: [
    ...
    "/crm/territories", "/crm/doctors", "/crm/gps-tracking", "/crm/market-requests", "/crm/reports",
    "/settings/profile",
  ],
  MEDICAL_REP: [
    "/dashboard", "/messages", "/tasks",
    "/hubs/crm",
    "/crm/accounts", "/crm/contacts", "/crm/tickets",
    "/crm/medical-rep", "/crm/territories", "/crm/doctors", "/crm/gps-tracking", "/crm/market-requests",
    "/settings/profile",
  ],
  ACCOUNTANT: [
    "/dashboard", "/messages", "/tasks",
