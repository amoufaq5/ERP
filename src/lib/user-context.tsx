...
export const ROLE_ROUTES: Record<UserRole, string[]> = {
  ...
  BUM: [
    ...
    "/crm/business-units", "/crm/territories", "/crm/weekly-plan", "/crm/doctors", "/crm/gps-tracking", "/crm/market-requests", "/crm/reports", "/crm/kpis",
  ...
  DISTRICT_MANAGER: [
    ...
    "/crm/territories", "/crm/weekly-plan", "/crm/doctors", "/crm/gps-tracking", "/crm/market-requests", "/crm/reports", "/crm/kpis",
    "/settings/profile",
  ],
  MEDICAL_REP: [
    "/dashboard", "/messages", "/tasks",
    "/hubs/crm",
    "/crm/accounts", "/crm/contacts", "/crm/tickets",
    "/crm/medical-rep", "/crm/territories", "/crm/weekly-plan", "/crm/doctors", "/crm/gps-tracking", "/crm/market-requests", "/crm/kpis",
    "/settings/profile",
  ],
  ACCOUNTANT: [
    "/dashboard", "/messages", "/tasks",
