...
// ---------------------------------------------------------------------------
// NotificationCenter – Bell icon with real-time SSE-powered dropdown
// ---------------------------------------------------------------------------
...
/** Check if notification type is critical (plays sound). */
function isCritical(type: NotificationType): boolean {
  return type === "SLA_BREACH" || type === "ESCALATION" || type === "ERROR";
}
...
export function NotificationCenter({ userId }: NotificationCenterProps) {
  ...
  const handleSSEEvent = useCallback(
    ...
    [addNotification, userId, soundEnabled]
  );
  ...
  const BellIcon = hasNewEvent ? BellRing : Bell;
  ...
  return (
    <div className="relative">
      ...
      >
        <BellIcon className={cn("h-5 w-5", hasNewEvent && "text-amber-500")} />
        {unreadCount > 0 && (
...
// ---------------------------------------------------------------------------
// Sound helper – plays a short notification beep using Web Audio API
// ---------------------------------------------------------------------------
